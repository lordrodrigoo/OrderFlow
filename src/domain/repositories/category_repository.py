...
class CategoryRepositoryInterface(ABC):
    ...
    @abstractmethod
    def get_category_by_id(self, category_id: int) -> Category | None: pass

    @abstractmethod
    def find_category_by_name(self, name: str) -> Category | None: pass

    @abstractmethod
    def create_category(self, category: Category) -> Category: pass

    @abstractmethod
    def update_category(self, category: Category) -> Category | None: pass
