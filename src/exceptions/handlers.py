...
from src.exceptions.exception_handlers_order import (
    ...
    OrderAddressNotFoundException, order_address_not_found_exception_handler,
)
from src.exceptions.exception_handlers_order_item import (
    ...
    OrderItemPermissionDeniedException, order_item_permission_denied_exception_handler,
)
from src.exceptions.exception_handlers_review import (
    ...
    ReviewPermissionDeniedException, review_permission_denied_exception_handler,
)
from src.exceptions.exception_handlers_auth import (
    ...
    OwnerForbiddenException, owner_forbidden_exception_handler,
)
...
def register_exception_handlers(app: FastAPI):
    ...
    app.add_exception_handler(OrderAddressNotFoundException, order_address_not_found_exception_handler)
    ...
    app.add_exception_handler(OrderItemPermissionDeniedException, order_item_permission_denied_exception_handler)
    ...
    app.add_exception_handler(ReviewPermissionDeniedException, review_permission_denied_exception_handler)
    ...
    app.add_exception_handler(OwnerForbiddenException, owner_forbidden_exception_handler)
