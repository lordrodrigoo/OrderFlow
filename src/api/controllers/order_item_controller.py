...
from src.api.dependencies import get_order_item_usecase, get_current_user
...
def delete_order_item(
    ...
    order_item_usecase.delete_order_item(order_item_id, current_user.id, current_user.role)
...
def list_order_items(
    ...
    order_items = order_item_usecase.list_order_items(
        order_id=order_id,
